...
struct hospital_system {
	...
	hospital_system() {
		queues = vector<hospital_queue>(MAX_SPECIALIZATION); // This line initializes the queues vector with a fixed number of elements — specifically MAX_SPECIALIZATION (which is defined as 20
